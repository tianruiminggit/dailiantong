      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="sendOrderManage.html">发单管理</a></li>
            <li><a href="receiveOrderManage.html">接单管理</a></li>
            <li><a href="forms.html">个人资料</a></li>
						<li><a href="moneyManage.html">资金管理</a></li>
            <li><a href="gameSetting.html">游戏设置</a></li>
            <li><a href="employeeManage.html">员工管理</a></li>
            <li><a href="smallAccount.html">子帐号管理</a></li>
          </ul>
          ...
          <!--<ul class="nav navbar-nav navbar-right navbar-user">
            <li class="dropdown messages-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-envelope"></i> 订单详情 <span class="badge">7</span> <b class="caret"></b></a>
              <ul class="dropdown-menu">
            ...
            <li class="dropdown alerts-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bell"></i> 公告详情 <span class="badge">3</span> <b class="caret"></b></a>
              <ul class="dropdown-menu">
      ...
      <div id="page-wrapper">
        ...
        <!--<div class="row">
          ...
          <div class="col-lg-4">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-money"></i>游戏设置</h3>
              </div>
              <div class="panel-body">
                <div class="table-responsive">
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    <thead>
                      <tr>
                        <th>常用游戏<i class="fa fa-sort"></i></th>
                        <th>擅长游戏<i class="fa fa-sort"></i></th>
                        <!--<th>投诉信息 <i class="fa fa-sort"></i></th>
                        <th>投诉时间<i class="fa fa-sort"></i></th>-->
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
